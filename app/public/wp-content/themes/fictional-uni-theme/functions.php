...
function university_files() {
    ...
    if (strstr($_SERVER['SERVER_NAME'], 'fictional-university.local')) {
        ...
        wp_enqueue_script('main-uni-js', get_theme_file_uri('/bundled-assets/scripts.338fd66d77c571917fe1.js'), NULL, '1.0', true);
        wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.338fd66d77c571917fe1.css'));
    }
